...
-   San Marcos had the lowest number of `listings` in January of 2015, which can be found by inputting the code above or typing in to the console `View(txhousing)`
:::
